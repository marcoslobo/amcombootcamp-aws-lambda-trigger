...
WORKDIR /src
COPY ["amcom.bootcamp.storageTrigger5.csproj", "amcom.bootcamp.storageTrigger5/"]
RUN dotnet restore "amcom.bootcamp.storageTrigger5/amcom.bootcamp.storageTrigger5.csproj"

WORKDIR "/src/amcom.bootcamp.storageTrigger5"
COPY . .
RUN dotnet build "amcom.bootcamp.storageTrigger5.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "amcom.bootcamp.storageTrigger5.csproj" \
...
Execute unit tests
```
cd "amcom.bootcamp.storageTrigger5/test/amcom.bootcamp.storageTrigger5.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "amcom.bootcamp.storageTrigger5/src/amcom.bootcamp.storageTrigger5"
